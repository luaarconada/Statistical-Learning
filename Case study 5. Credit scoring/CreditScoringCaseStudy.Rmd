...
93% good loans, 7% bad loans: unbalanced dataset (same unbalance with 40% training and 30%). For a naive director (all people classified as good), the accuracy in next week's clients will be 93% (+-2%, some uncertainty). This director is going to spend a lot of many in that 7% of the bad people, he is going to fail with very few people, 7%, but he is going to lose millions (statistically very good, economically a disaster).
...
The total cost due to the naive director is
0.12*97310 - 1*6006 - 0.01*671 + 0*1012
